...
function Ebike() {
  return (
    <>
    <div className=" w-[100vw] ml-0 lg:max-w-[1200px] mt-10 p-4  lg:ml-72  lg:mt-[8rem]">
     ...
     <div className='w-[48px] h-[48px] bg-gradient-to-b from-[#ffbc3794] to-[#ffbc37] rounded-full flex justify-center items-center cursor-pointer '>
         <BsArrowLeft className="swiper-custom-navigation swiper-custom-navigation-prev backNavigate" size={27} fill='#233348'/>
     </div>
     <div className='w-[48px] h-[48px] bg-gradient-to-b from-[#ffbc3794] to-[#ffbc37] rounded-full flex justify-center items-center cursor-pointer '>
     <BsArrowRight className="swiper-custom-navigation swiper-custom-navigation-next frontNavigate" size={27} fill='#233348'/>
     </div>
   </div>
   </>
  )
